...
# Optional: uncomment if you want to load from a .env file
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "frontend" / "templates", BASE_DIR / "backend" / "templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
INDIA_EMERGENCY_NUMBER = os.environ.get('INDIA_EMERGENCY_NUMBER', '+91-0000000000')
INDIA_SMS_SHORT_CODE = os.environ.get('INDIA_SMS_SHORT_CODE', '0000')
